...
const getIconSrc = (iconType: string) => {
  // 使用import方式导入图片，确保正确的路径解析
  const iconMap = {
    'clipboard': new URL('@renderer/assets/img/请购单.png', import.meta.url).href,
    'shopping-cart': new URL('@renderer/assets/img/请购单.png', import.meta.url).href,
    'folder': new URL('@renderer/assets/img/请购单.png', import.meta.url).href,
    'document': new URL('@renderer/assets/img/请购单.png', import.meta.url).href,
    'calendar': new URL('@renderer/assets/img/请购单.png', import.meta.url).href,
    'task': new URL('@renderer/assets/img/请购单.png', import.meta.url).href
  }
  return iconMap[iconType] || new URL('@renderer/assets/img/请购单.png', import.meta.url).href
}
